...
- Расскажите, как ограниченные контексты помогают управлять сложностью в больших системах.
...
- Расскажите о концепцию дизайна, ориентированного на пользовательский интерфейс в контексте DDD.
...
**Репозитории против Query объектов:**
- Разграничьте репозитории и Query объекты в DDD.
- В каких случаях вы бы использовали репозиторий, а в каких - Query объект?

**Стратегии отображения контекстов:**
- Приведите примеры различных стратегии отображения контекстов в DDD.
- Расскажите о роли карт контекста в выравнивании различных ограниченных контекстов.

**Доменные события против событий уровня интеграции в DDD:**
- В чем разница между доменными событиями и событиями уровня интеграции в DDD?
